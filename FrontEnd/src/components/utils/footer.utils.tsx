...
export default function Footer() {
	return (
		<footer className="bg-[#fbeed4] rounded-t-lg font-medium">
			<div className="flex flex-col w-4/5 m-auto">
				<section className="flex flex-row items-center gap-5 mt-15 bg-[#003459] text-white py-7 px-6 rounded-xl font-medium text-lg">
					...
					<div className="flex flex-row flex-1 justify-end bg-white p-3 rounded-xl gap-3">
						<input
							...
							className="border py-2 px-4 border border-black text-black rounded-xl outline-none flex-1"
						/>
						<button className="text-black py-2 px-4 text-base bg-[#003459] text-white font-normal border border-transparent rounded-xl hover:bg-blue-900 transition hover:cursor-pointer">
							Subscribe Now
						</button>
					</div>
				</section>
				...
				<section className="flex flex-row justify-between py-10 items-center text-[#667479]">
					...
					<div className="flex flex-row gap-10">
						<p className="hover:cursor-pointer hover:text-gray-600">
							Terms of Service
						</p>
						<p className="hover:cursor-pointer hover:text-gray-600">
							Privacy Policy
